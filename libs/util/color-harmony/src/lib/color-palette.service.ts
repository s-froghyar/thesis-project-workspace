...
export class ColorPaletteService {
  ...
  public linGradTransform(
    ch: ColorHarmony,
    from: ColorHamronyFields,
    to: ColorHamronyFields
  ): string {
  ...
  public getColorString(type: ColorHamronyFields): string {
